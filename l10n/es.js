...
"agreedisclaimer",
{
    ...
    "Al activar esta opción, dos cookies serán almacenadas",
    ...
    "Fecha y hora de la última visita del usuario",
    ...
    "Intervalo de expiración para cookies nuevas",
    ...
    "Si el archivo de texto es más grande que este tamaño, sus contenidos no serán mostrados completamente en el diálogo; ajúste este valor hasta que sea adecuado a sus necesidades",

    "If true, it indicates that the user is a returning visitor, who already accepted the disclaimer":
    "Si es verdadero, indica que el usuario ya ha visitado el sitio y ha aceptado la exclusión de responsabilidad",
    ...
    "Si usted quiere modificar este límite, hágalo bajo su propia responsabilidad cambiando el valor del parámetro: maxAppTxtFileSize dentro del archivo config.php",
    ...
    "Asegúrese de que el archivo existe y puede ser leído por el usuario de apache",
    ...
    "Para activar más idiomas, ubique sus archivos aquí",
    ...
    "Usar una cookie para recordar la elección del usuario",
